...
INSERT INTO UserAccount (UserName, FirstName, LastName, UserRoleID, AvatarID, CreatedDateTime, ModifiedDateTime)
VALUES ("user1", "First", "Last", 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
